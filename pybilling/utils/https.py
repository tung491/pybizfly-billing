...
from pybilling.constants.methods import GET, METHODS
from pybilling.constants.response_codes import TOO_MANY_REQUEST
from pybilling.utils.validators import validate_str_list, validate_dict_list, validate_method
...
def _retry_request(num_retry: int, uri: str, method: str, **kwargs):
    ...
    return response_status, response_content, response_headers
