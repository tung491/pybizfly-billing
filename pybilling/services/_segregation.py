...
from pybilling.constants import (GET, CREATE, UPDATE, DELETE, PUT, METHODS)
from pybilling.utils import (build_uri, env_or_dict, HttpRequest, Authenticator)


class Service(ABC):
    def __init__(self, tenant_id: str, api_url: str = None, auth_token: str = None, client=None):
        ...
        self.__billing_api_url = api_url or env_or_dict({}, 'BILLING_API_URL')
    ...
    def __prepare_service(self):
        ...
        # from pybilling.client import BizFlyBillingClient
        # if isinstance(self.__client, BizFlyBillingClient):
